...
For mocking the application, Firefox \cite{firefox} browser is used by this thesis.
...
The following commands can be used to start up the project quickly. It watches any change within the project and refreshes automatically. Hence, it is useful for UI development. Note that in this case the Java back-end will not be included.
