...
The back-end consumes database service through CAP's provided persistence service library \cite{cap-java-persistencesrv}, while the front-end communicates with back-end through the OData protocol \cite{odata}.
