...
\begin{figure}[H]
	...
	\subcaptionbox{Home Screen with Packages}{
		\includegraphics[width=0.4\linewidth]{images/user_doc/pickup/HomeScreenList.png}}
	\hspace{5pt}
	\subcaptionbox{Home Screen without Packages}{
		\includegraphics[width=0.4\linewidth]{images/user_doc/pickup/HomeScreenNoPackage.png}}
